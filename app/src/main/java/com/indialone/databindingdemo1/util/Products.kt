...
class Products {
    ...
    var PRODUCT_MAP: HashMap<String, Product> = HashMap()

    companion object {
        val RED_LAMP = Product(
            "Red Lamp",
            "Red colored lamp, perfect for lighting up a room " +
                    "and matching any red furniture.",
            R.drawable.red_lamp,
            BigDecimal(10.99),
            BigDecimal(9.50),
            161,
    ...
    init {
        for (product in PRODUCTS) {
            PRODUCT_MAP[java.lang.String.valueOf(product.serial_number)] = product
        }
    }
}
